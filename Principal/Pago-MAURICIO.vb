...
Public Class Pago
    ...
    Private Sub Pago_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ponerFoto()
        CreeTabla("cliente", "SELECT * FROM cliente where huella is not null order by huella")
    ...
    Public Sub traerTarias()
        Dim arlCoincidencias = Gestor1.DatosDeConsulta("SELECT serial,tipo,valor,dias FROM precio where det=1", , Principal.cadenadeconexion)
