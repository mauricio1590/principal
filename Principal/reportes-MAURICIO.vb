Public Class reportes
    ...
    Private Sub TextBox1_MouseMove(sender As Object, e As MouseEventArgs) Handles txtReporte.MouseMove

    End Sub

    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txtReporte.TextChanged
    End Sub
    ...
    Private Sub reportes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtReporte.Focus()
        lstreporte.Visible = True
        Dim arlCoincidencias = Gestor1.DatosDeConsulta("SELECT id,no FROM reporte ORDER BY ORDEN ASC", , Principal.cadenadeconexion)
    ...
    Private Sub fhasta_ValueChanged(sender As Object, e As EventArgs) Handles fhasta.ValueChanged
    ...
    Public Sub buscarDatos()
        ...
        If Not lstreporte.SelectedItems.Count = 0 Then
            con.VisualizarRortes(lstreportes, Format(fecha1, "yyyy-MM-dd"), Format(fecha2, "yyyy-MM-dd"), lstreporte.SelectedItems(0).Tag, txtTotal, , , intTarjeta)
    ...
    Private Sub lsttarifas_MouseClick(sender As Object, e As MouseEventArgs) Handles lstreporte.MouseClick
        If lstreporte.SelectedItems.Count = 0 Then Exit Sub
        lsttag = lstreporte.SelectedItems(0).Tag
        If lsttag = 7 Then
            Principal.intValidar = 5
