Public Class Arqueoventa
    ...
    Private Sub Arqueo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End If
        con.VisualizarRortes(lstreportes, Now.Date, Now.Date, 301, txtTotal, , intIdDeLaPersona)
        If Principal.intNivelUsuario < 4 Then
    ...
    Private Sub btnArqueo_Click(sender As Object, e As EventArgs) Handles btnArqueo.Click
        ...
        Else
            ...
            If res1 = Windows.Forms.DialogResult.Yes Then
                strcadena = "DELETE FROM CAJA1 WHERE usuario = " & intIdDeLaPersona & ""
            End If
        End If
        ...
        con.VisualizarRortes(lstreportes, Now.Date, Now.Date, 301, txtTotal)
    End Sub
